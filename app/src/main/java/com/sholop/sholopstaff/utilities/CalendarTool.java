...
public class CalendarTool {
    ...
    //constructor using jalali date string
    public CalendarTool( String jalaliDateString ){
        int jalaliYear = Integer.parseInt(jalaliDateString.substring(0,4));
        int jalaliMonth = Integer.parseInt(jalaliDateString.substring(4,6));
        int jalaliDay = Integer.parseInt(jalaliDateString.substring(6));

        this.setIranianDate(jalaliYear, jalaliMonth, jalaliDay);
    }
    ...
    /**
     * getJalaliDayOfWeek:
     * Returns the week day number. Shanbe=0..Jome=6;
     * @return int
     */
    ...
    public String getIranianDateString(){
        return String.valueOf(this.getIranianYear()) + String.valueOf(this.getIranianMonth()) +
                String.valueOf(this.getIranianDay());
    }

    public String getJalaliDisplayDate(Context context) {
        Resources res = context.getResources();
        String []weekdays = res.getStringArray(R.array.jalali_week_days);
        String []jalaliMonthNames = res.getStringArray(R.array.jalali_month_names);

        return weekdays[this.getJalaliDayOfWeek()] + ", " +
                getIranianDay() + " " +
                jalaliMonthNames[getIranianMonth()-1] + " " +
                getIranianYear();
    }

    public String getGregorianDisplayDate(Context context) {
        Resources res = context.getResources();
        String []weekdays = res.getStringArray(R.array.gregorian_week_days);
        String []gregorianMonthNames = res.getStringArray(R.array.gregorian_month_names);

        return weekdays[getDayOfWeek()] + ", " +
                getGregorianDay() + " " +
                gregorianMonthNames[getGregorianMonth()-1] + " " +
                getGregorianYear();
    }


    public String getDateString(){
        return String.valueOf(this.getGregorianYear()) +
                String.valueOf(this.getGregorianMonth()<10 ? "0"+this.getGregorianMonth() : this.getGregorianMonth()) +
                String.valueOf(this.getGregorianDay()<10 ? "0" + this.getGregorianDay() : this.getGregorianDay());
    }
